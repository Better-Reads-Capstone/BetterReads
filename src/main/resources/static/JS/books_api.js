    ...
    fetch(baseUrl + new URLSearchParams({
        ...
        .then(result => {
            for (let i = 0; i < result.items.length; i++) {
                ...
                document.getElementById("search-results").innerHTML += `<form class='form-inline my-2 my-lg-0' method="POST" action="/book/${item.volumeInfo.industryIdentifiers[0].identifier}/create"><button class='btn my-2 my-sm-0' type='submit' id='addBookBtn'>Add Book</button>`;
